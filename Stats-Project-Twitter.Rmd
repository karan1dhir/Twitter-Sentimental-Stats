...
#visualize those countries on map having heighest frequency of tweets.
...
show_countries_map <- function(tweet_df){
  ...
  location_filtered <- as.data.frame(sapply(location_new, grepl, pattern = ",", fixed = TRUE))
  location_new <- location_all[location_filtered$location == TRUE,] %>% slice(1:10)
  
lat <- c(0.347596,37.0902,35.3395,40.7128,37.9060,52.5200,45.4869,36.9741,37.0902,37.0902)
long <- c(32.582520,95.7129,97.4867,74.0060,122.5450,13.4050,122.8040,122.0308,95.7129,95.7129)
location_df <- data.frame(location_new$location,location_new$n, lat, long)
...
leaflet(location_df) %>% addTiles() %>%
  addAwesomeMarkers(~long, ~lat, icon=icons,label = (location_df$location_new.n))
}
